...
# 1. Planets that support only
# Gravity.




# 2. Planets that support both
# gravity and are of suited types


# 3. Planets that support all gravity,
# are of suitable type and fall in
# goldilock zone.


# 4. Planets that support all gravity,
# are of suitable types and have
# suitable speed that we can
# survive.


# 5. Planets that are potentially
# habitable that support all the
# above filters.
